...
public class SpatialJoinQuery<U extends Geometry>
    ...
    public SpatialJoinQuery(SpatialLocalIndex.QueryMethod queryMethod) {
    ...
    public Iterator<Tuple2<String, Integer>> call(Iterator<Tuple2<Integer, SpatialLocalIndex>> indexIterator, Iterator<U> streamShapes)
        ...
        result = treeIndex.count(queryGeometry, queryMethod);
