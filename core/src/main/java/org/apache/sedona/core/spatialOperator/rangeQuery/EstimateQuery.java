...
public class EstimateQuery<U extends Geometry>
    ...
    public EstimateQuery(SpatialLocalIndex.QueryMethod queryMethod) {
    ...
    public Iterator<Double> call(Iterator<Tuple2<Integer, SpatialLocalIndex>> indexIterator, Iterator<U> streamShapes)
        ...
        result = treeIndex.estimate(queryGeometry, queryMethod);
